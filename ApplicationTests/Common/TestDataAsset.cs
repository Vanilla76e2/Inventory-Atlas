...
namespace ApplicationTests.Common
{
    internal class TestDataSet
    {
        ...
        internal GenericInventoryItem GenericInventoryItemTest;
        ...
        internal TestDataSet()
        {
            ...
            InventoryCategoryTest = new InventoryCategory()
            {
                ...
                UpdatedAt = DateTime.Parse("2025-10-10 10:10:10+05"),
                Name = "CCTV",
                Description = "Устройства видеонаблюдения",
                CustomFields = "[\"Color\", \"IP\"]",
                Items = new List<GenericInventoryItem>()
            };
            ...
            GenericInventoryItemTest = new GenericInventoryItem()
            {
                Id = 1,
                CreatedAt = DateTime.Parse("2025-10-10 10:10:10+05"),
                UpdatedAt = DateTime.Parse("2025-10-10 10:10:10+05"),
                ...
                InventoryNumber = "101341000111",
                RegistryNumber = "00:1212:3434",
                ResponsibleId = 1,
                Responsible = null!,
                Location = "404",
                ...
                CategoryId = 1,
                Category = null!,
                Properties = "{\"Color\": true, \"IP\": \"192.168.0.10\"}"
            };
            ...
            InventoryCategoryTest.Items.Add(GenericInventoryItemTest);
            GenericInventoryItemTest.Category = InventoryCategoryTest;
            ...
            GenericInventoryItemTest.Responsible = MateriallyResponsible1Test;
            MateriallyResponsible1Test.Items.Add(GenericInventoryItemTest);
            GenericInventoryItemTest.InventoryItemPhotos.Add(InventoryPhotoTest);
            InventoryPhotoTest.InventoryItemId = GenericInventoryItemTest.Id;
