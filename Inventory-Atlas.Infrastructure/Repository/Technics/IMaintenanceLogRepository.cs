...
namespace Inventory_Atlas.Infrastructure.Repository.Technics
{
    ...
    public interface IMaintenanceLogRepository : IDatabaseRepository<MaintenanceLog>
    {
        ...
        Task<IEnumerable<MaintenanceLog>> GetByDeviceIdAsync(int deviceId);
        ...
        Task<IEnumerable<MaintenanceLog>> GetByEmployeeIdAsync(int employeeId);
        ...
        Task<IEnumerable<MaintenanceLog>> GetByDateRangeAsync(DateTime from, DateTime to);
        ...
        Task<IEnumerable<MaintenanceLog>> GetByMaintenanceTypeAsync(MaintenanceType type);
    }
}