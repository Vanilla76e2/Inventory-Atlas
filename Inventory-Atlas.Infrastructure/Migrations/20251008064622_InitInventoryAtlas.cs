    ...
    public partial class InitInventoryAtlas : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IpAudit", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PrinterCartriges", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserProfiles_Employees_employee_id",
                        column: x => x.employee_id,
                        principalSchema: "Employees",
                        principalTable: "Employees",
                        principalColumn: "id");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Favourite_UserProfiles_user_id",
                        column: x => x.user_id,
                        principalSchema: "Users",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    dhcp = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    panel_type = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    vga_port = table.Column<short>(type: "smallint", nullable: true),
                    hdmi_port = table.Column<short>(type: "smallint", nullable: true),
                    display_port = table.Column<short>(type: "smallint", nullable: true),
                    dvi_port = table.Column<short>(type: "smallint", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Printers_PrinterCartriges_cartridge_id",
                        column: x => x.cartridge_id,
                        principalSchema: "Consumables",
                        principalTable: "PrinterCartriges",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserProfiles_employee_id",
                schema: "Users",
                table: "UserProfiles",
                column: "employee_id");
