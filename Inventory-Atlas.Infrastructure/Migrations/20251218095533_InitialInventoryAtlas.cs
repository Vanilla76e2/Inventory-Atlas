        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    materially_responsible_id = table.Column<int>(type: "integer", nullable: false),
                    comment = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CheckoutDocuments_MateriallyResponsibles_materially_respons~",
                        column: x => x.materially_responsible_id,
                        principalSchema: "Employees",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ReturnDocuments_MateriallyResponsibles_materially_responsib~",
                        column: x => x.materially_responsible_id,
                        principalSchema: "Employees",
                        principalTable: "MateriallyResponsibles",
                        principalColumn: "id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TransferDocuments_MateriallyResponsibles_materially_respons~",
                        column: x => x.materially_responsible_id,
                        principalSchema: "Employees",
                        principalTable: "MateriallyResponsibles",
                        principalColumn: "id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WriteOffDocuments_MateriallyResponsibles_materially_respons~",
                        column: x => x.materially_responsible_id,
                        principalSchema: "Employees",
                        principalTable: "MateriallyResponsibles",
                        principalColumn: "id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserSessions_UsersProfiles_user_id",
                        column: x => x.user_id,
                        principalSchema: "Users",
            ...
            migrationBuilder.CreateTable(
                name: "WorkplaceEquipmentRepository",
                schema: "Inventory",
                columns: table => new
                {
                    id = table.Column<int>(type: "integer", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkplaceEquipmentRepository", x => x.id);
                    table.ForeignKey(
                        name: "FK_WorkplaceEquipmentRepository_Equipments_equipment_id",
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_WorkplaceEquipmentRepository_Workplaces_workplace_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FurnitureMaterialAssignments_FurnitureMaterials_material_id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CheckoutDocuments_materially_responsible_id",
                schema: "Documents",
                table: "CheckoutDocuments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FurnitureMaterialAssignments_material_id",
                schema: "Inventory",
                table: "FurnitureMaterialAssignments",
                column: "material_id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReturnDocuments_materially_responsible_id",
                schema: "Documents",
                table: "ReturnDocuments",
                column: "materially_responsible_id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TransferDocuments_materially_responsible_id",
                schema: "Documents",
                table: "TransferDocuments",
                column: "materially_responsible_id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkplaceEquipmentRepository_equipment_id",
                schema: "Inventory",
                table: "WorkplaceEquipmentRepository",
                column: "equipment_id");

            migrationBuilder.CreateIndex(
                name: "IX_WorkplaceEquipmentRepository_workplace_id",
                schema: "Inventory",
                table: "WorkplaceEquipmentRepository",
                column: "workplace_id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WriteOffDocuments_materially_responsible_id",
                schema: "Documents",
                table: "WriteOffDocuments",
                column: "materially_responsible_id");
        }
